 ...
 *
 * Account preferences (theme / locale / contrast) follow the USER across
 * devices, so they live in their own per-user server row — separate from the
 * project, and deliberately NOT part of the project import. This module is the
...
/** Equality key for the autosave diff — the four preference fields. */
