...
export async function collaborationSha256Hex(
  update: Uint8Array,
  ...
  return portableSha256Hex(update)
}

export function collaborationCommandId(
  cryptoApi: SecureUuidCrypto | null | undefined = globalThis.crypto,
): string {
  return createSecureUuid(cryptoApi)
}

function portableSha256Hex(input: Uint8Array): string {
