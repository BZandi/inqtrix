...
export const editorCopy = {
  de: {
    ...
    codeBlockCopy: 'Code kopieren',
    codeBlockCopied: 'Kopiert',
    codeBlockLanguageAria: 'Sprache des Codeblocks',
    codeBlockLanguagePlain: 'Text',
    codeBlockLanguageUnavailable:
      'Im Vorschlags- und Kommentarmodus nicht änderbar',
  ...
  en: {
    ...
    codeBlockLanguageAria: 'Code block language',
    codeBlockLanguagePlain: 'Text',
    codeBlockLanguageUnavailable:
      'Not changeable in suggestion or comment mode',
