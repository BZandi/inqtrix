...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "health_not_configured": {"de": "nicht konfiguriert", "en": "not configured"},
    ...
    "label_server_url":   {"de": "Server-URL",      "en": "Server URL"},
    "server_url_placeholder": {
        "de": "http://192.168.1.42:5100",
        "en": "http://192.168.1.42:5100",
    },
    "server_url_help": {
        "de": (
            "Primärquelle ist `INQTRIX_WEBAPP_BASE_URL`. Wenn die Variable "
            "nicht gesetzt ist, URL hier manuell eintragen und übernehmen."
        ),
        "en": (
            "Primary source is `INQTRIX_WEBAPP_BASE_URL`. If it is unset, "
            "enter the URL here manually and apply."
        ),
    },
    "btn_apply_server_url": {"de": "Übernehmen", "en": "Apply"},
    "btn_reset_server_url": {"de": "Env laden", "en": "Load env"},
    "server_url_missing": {
        "de": "Keine Server-URL gesetzt. Setze `INQTRIX_WEBAPP_BASE_URL` oder trage sie hier ein.",
        "en": "No server URL configured. Set `INQTRIX_WEBAPP_BASE_URL` or enter it here.",
    },
    "server_url_env_active": {
        "de": "Env aktiv: `{url}`",
        "en": "Env active: `{url}`",
    },
    "server_url_env_absent": {
        "de": "Env fehlt: `INQTRIX_WEBAPP_BASE_URL`",
        "en": "Env missing: `INQTRIX_WEBAPP_BASE_URL`",
    },
    ...
    "composer_placeholder_no_server": {
        "de": "Bitte zuerst eine Server-URL konfigurieren",
        "en": "Please configure a server URL first",
    },
    ...
    "warn_no_stack_no_server": {
        "de": "Kein Stack verfügbar, weil keine Server-URL gesetzt ist.",
        "en": "No stack available because no server URL is configured.",
    },
