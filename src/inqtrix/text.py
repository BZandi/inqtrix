...
#
# The risk_scoring strategy (substring scan over context blocks) expands a
# required aspect into a list of related German keywords so aspect-coverage
# estimation matches synonyms, not just the literal aspect wording.
# ---------------------------------------------------------------------------
